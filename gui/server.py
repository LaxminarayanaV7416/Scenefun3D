...
class ServerGUI:
    ...
    def __init__(self, data_dir, visit_id, video_id):
        ...
        self.gui_default_example_button = self.server.gui.add_button("Show Default Example")
        ...
        self.gui_default_example_button.on_click(self.show_rgb_on_laser_scan)
        self.gui_reset_scene.on_click(self.show_empty_frame)

        ## on update events
        self.show_frame.on_update(lambda _ : self.draw_frame())
        self.visit_id_dropdown.on_update(lambda _ : self.update_visit_id_dropdowns())

    def run(self):
        while True:
            time.sleep(0.2)

    def update_visit_id_dropdowns(self):
    ...
    def show_rgb_on_laser_scan(self, gui_event):
        ...
        loading_notif = gui_event.client.add_notification(
            title="Loading Show Default Example",
